...
export const PROBLEMS: Problem[] = [
  ...
  {
    id: "partition-labels-two-pointers",
  ...
  },
  {
    ...
    name: "Find Minimum Rotated Array",
    difficulty: "Medium",
    category: "Binary Search",
  ...
  {
    id: "best-time-to-buy-stock-with-cooldown",
    name: "Best Time To Buy Stock With Cooldown",
    difficulty: "Medium",
    category: "Dynamic Programming",
